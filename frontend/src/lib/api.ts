...
import {
    ...
    type AdvancedModuleConfig,
    type ApplicationEmojiPage,
    type ApplicationEmojiSettings,
    type ApplicationEmojiSyncResult,
    type AuthResponse,
    type AutoActivityClockCity,
    type AutoActivityClockDashboard,
    type AutoActivityClockSettings,
    type BoosterDashboard,
    type BoosterSettings,
    type BotBillingAccess,
    type BotBillingInvoice,
    type BotBillingModel,
    type BotCredential,
    type BotGuildConfig,
    type ClipPlatform,
    type ClipRankingEntry,
    type ClipSent,
    type ClipStats,
    type ClipsConfig,
    type ClipsConfigPage,
    type Course,
    type CourseExamDashboard,
    type CourseExamQuestion,
    type CourseHistorySettings,
    type CourseInstructorTrackingSettings,
    type CoursesDashboard,
    type CreateDevBotPayload,
    type CreateKickNotificationPayload,
    type CreateTwitchNotificationPayload,
    type CustomBotOrderSettings,
    type CustomBotOrdersDashboard,
    type CustomPanel,
    type CustomPanelCategory,
    type CustomPanelsDashboard,
    type CustomerPlansDashboard,
    type DashboardBot,
    type DashboardMeResponse,
    type DevAccessEntry,
    type DevAccessRole,
    type DevBot,
    type DevModuleDefinition,
    type DevMonthlyContract,
    type DevPlansDashboard,
    type DiscloudLogsResponse,
    type DiscloudMonitoringResponse,
    ...
    type FivemGoalDashboard,
    type FivemGoalSettings,
    type FivemGoalSubmission,
    type FivemHierarchyDashboard,
    type FivemHierarchyPanel,
    type FivemModuleDefinition,
    type FivemOrderDashboard,
    type FivemOrderProduct,
    type FivemOrderSettings,
    type FivemOrderStatus,
    type Giveaway,
    type GiveawayDiagnostics,
    type GiveawayEntryResult,
    type GiveawayIdentity,
    type GiveawayLivePreview,
    type GiveawaySpinResult,
    type GlobalBlacklistDashboard,
    type GlobalBlacklistSafeBotSettings,
    type GuildLiveOptions,
    type GuildMemberOption,
    type GuildRoleOption,
    type GuildSettings,
    type HierarchyForwardingRule,
    type ImageAntiSpamResponse,
    type ImageAntiSpamSettings,
    type KickChannelPreview,
    type KickClipChannelPreview,
    type KickIntegrationStatus,
    type KickNotification,
    type KickNotificationsPage,
    type LiveDetectionSettings,
    type LiveEvent,
    type LivePanelPreview,
    type LogEntry,
    type MaintenanceState,
    type ManualPaymentsDashboard,
    ...
    type NexTechSalesDashboard,
    type NexTechSalesPlan,
    type NexTechSalesSettings,
    type OpenDutyDashboard,
    type PanelImageSettings,
    type Plan,
    type PlanFeature,
    type PlanSubscription,
    type PoliceTimeClockDashboard,
    type PoliceTimeClockSettings,
    type PriceTable,
    type PriceTablesDashboard,
    type PublicKickClips,
    type PublicNexTechInvitePage,
    type PublicNexTechProduct,
    type ReplaceNexTechInviteUrlPayload,
    type RhAdminDashboard,
    type SalesTicketDashboard,
    type SalesTicketSettings,
    type SalesTicketType,
    type SaveBoosterSettingsPayload,
    type SaveClipsConfigPayload,
    type SaveCourseExamQuestionPayload,
    type SaveCourseExamSettingsPayload,
    type SaveCoursePayload,
    type SaveCourseSettingsPayload,
    type SaveCustomBotOrderSettingsPayload,
    type SaveCustomPanelCategoryPayload,
    type SaveCustomPanelPayload,
    type SaveFivemFacSettingsPayload,
    type SaveFivemModulePayload,
    ...
    type SavePlanFeaturePayload,
    type SavePlanPayload,
    type SavePriceTablePayload,
    type SaveRhAdminSettingsPayload,
    type SaveSalesTicketSettingsPayload,
    type SaveSalesTicketTypePayload,
    type SaveSelfBotProtectionSettingsPayload,
    type SaveSocialPanelPayload,
    type SaveSubscriptionPresenceProductPayload,
    type SaveSubscriptionPresenceSettingsPayload,
    type SaveSystemEmojiPayload,
    type SaveVoiceRecorderSettingsPayload,
    type SaveXAccountPayload,
    type SaveZtkRewardPayload,
    type SaveZtkWebhookClanPayload,
    type SelfBotProtectionResponse,
    type SelfBotProtectionSettings,
    type ServerBackupDashboard,
    type ServerBackupRestorePart,
    type ServerBackupRestorePreview,
    ...
    type SocialPanel,
    type SubscriptionPresenceDashboard,
    type SubscriptionPresenceProduct,
    type SubscriptionPresenceSettings,
    ...
    type XAccount,
    type XAccountPreview,
    type XMonitorResponse,
    type ZtkReward,
    type ZtkWebhookClan,
    type ZtkWebhookDashboard,
    type Pd7Dashboard,
    type Pd7Settings
} from "../types";
...
export async function deletePoliceReportsQuestion(guildId: string, botId: string, questionId: string) { const { data } = await api.delete<{ question: import("../types").PoliceReportsQuestion | null }>(`/police-recruitment/${guildId}/questions/${questionId}`, { params: botParams(botId) }); return data.question; }
export async function movePoliceReportsQuestion(guildId: string, botId: string, questionId: string, direction: "up" | "down") { const { data } = await api.post<{ questions: import("../types").PoliceReportsQuestion[] }>(`/police-recruitment/${guildId}/questions/${questionId}/move`, { direction }, { params: botParams(botId) }); return data.questions; }
...
export async function getPoliceRankUpDashboard(guildId: string, botId: string) { const { data } = await api.get<import("../types").PoliceRankUpDashboard>(`/police-rank-up/${guildId}`, { params: botParams(botId) }); return data; }
export async function savePoliceRankUpSettings(guildId: string, botId: string, payload: Partial<import("../types").PoliceRankUpSettings>) { const { data } = await api.patch<{ settings: import("../types").PoliceRankUpSettings }>(`/police-rank-up/${guildId}/settings`, payload, { params: botParams(botId) }); return data.settings; }
export async function publishPoliceRankUpPanel(guildId: string, botId: string) { const { data } = await api.post<{ settings: import("../types").PoliceRankUpSettings }>(`/police-rank-up/${guildId}/publish`, undefined, { params: botParams(botId) }); return data.settings; }
...
export async function uploadFivemFacPanelImage(guildId: string, botId: string, file: File) {
  const { data } = await api.put<{ settings: FivemFacSettings }>(
    `/fivem/${guildId}/fac/panel-image`,
    file,
    {
      headers: {
        "Content-Type": file.type || "application/octet-stream"
