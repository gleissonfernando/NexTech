...
import type { BotStatus, DashboardBot } from "../../types";
...
const navItems: NavItem[] = [
  ...
  { id: "police-patrol-reports", label: "Relatórios de Patrulhamento", icon: ShieldCheck, moduleId: "police-patrol-reports" },
  { id: "police-reports", label: "Recrutamento Policial", icon: ScrollText, moduleIds: ["police_reports", "police-recruitment"] },
