...
export type PoliceReportsQuestion = {
  ...
  title: string;
  description: string | null;
  type: PoliceReportsQuestionType;
  required: boolean;
  options: string[];
  enabled: boolean;
  createdAt: string;
...
export type PoliceReportsSettings = {
  id: string;
  botId: string;
  guildId: string;
  enabled: boolean;
  ...
  createReportRoleIds: string[];
  editReportRoleIds: string[];
  deleteReportRoleIds: string[];
  viewAllReportsRoleIds: string[];
  manageQuestionsRoleIds: string[];
  manageConfigurationRoleIds: string[];
  forumChannelId: string | null;
  reportsForumChannelId: string | null;
  temporaryCategoryId: string | null;
  logChannelId: string | null;
  ...
  systemReady?: boolean;
  status?: "not_released" | "configuration_required" | "operational";
};
export type PoliceReportsDashboard = {
  logs: Array<{ action: string; actorId: string | null; createdAt: string; id: string; metadata: Record<string, unknown>; reportId: string | null; sessionId: string | null }>;
  questions: PoliceReportsQuestion[];
  reports: Array<Record<string, unknown>>;
  responsibles: Array<Record<string, unknown>>;
  settings: PoliceReportsSettings;
  stats: { inProgress: number; reports: number; responsibles: number; thisMonth: number };
  validation: { checks: Array<{ id: string; label: string; ok: boolean }>; ready: boolean };
};
...
export type PoliceQruSettings = { id: string; botId: string; guildId: string; enabled: boolean; recordChannelId: string | null; logChannelId: string | null; approvalChannelId: string | null; temporaryCategoryId: string | null; allowedRoleIds: string[]; supervisorRoleIds: string[]; teamRoleId: string | null; deleteChannelSeconds: number; color: string; panelTitle: string; panelDescription: string; panelImageUrl: string | null; panelMessage: string; rankingChannelId: string | null; rankingMessageId: string | null; rankingResetAt: string | null; createdAt: string; updatedAt: string };
...
export type PoliceRankUpDashboard = { logs: Array<{ action: string; actorId: string | null; actorName: string | null; createdAt: string; id: string; requestId: string | null }>; requests: PoliceRankUpRequest[]; settings: PoliceRankUpSettings; stats: { approved: number; pending: number; ranks: number; rejected: number; total: number } };
...
export type SaveNexTechInvitePayload = {
  ...
  blockUnknownInvites?: boolean;
  botId?: string | null;
  backgroundEffect?: NexTechInvite["backgroundEffect"] | null;
  buttonEmoji?: string | null;
  buttonLabel?: string | null;
  channelId?: string | null;
  clientName: string;
  ...
  inviteUrl?: string | null;
  landingPageEnabled?: boolean;
  landingPageTheme?: NexTechInvite["landingPageTheme"] | null;
  logChannelId?: string | null;
  logoUrl?: string | null;
  maxUses?: number | null;
  name: string;
  notes?: string | null;
  overlayStyle?: NexTechInvite["overlayStyle"] | null;
  particleStyle?: NexTechInvite["particleStyle"] | null;
  panelChannelId?: string | null;
  panelColor?: string | null;
  panelTitle?: string | null;
  permissions?: Partial<Record<"administrator" | "manager" | "moderator" | "viewer", string[]>>;
...
export type PublicNexTechInvitePage = {
  config: {
    ...
    showServerName: boolean;
    showVerificationBadges: boolean;
    theme: NonNullable<NexTechInvite["landingPageTheme"]>;
  };
  discord: {
  ...
  invite: Pick<NexTechInvite, "clientName" | "code" | "customSlug" | "description" | "id" | "name" | "panelColor">;
  redirectUrl: string;
  slug: string;
  valid: boolean;
};
...
export type PaymentProvider = "disabled" | "mercadopago" | "pagbank" | "stripe" | "asaas";
