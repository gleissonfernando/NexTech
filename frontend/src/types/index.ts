...
export type FivemActionSettings = { id: string; botId: string; guildId: string; architecture: FivemActionArchitecture; enabled: boolean; categoryId: string | null; panelChannelId: string | null; actionChannelId: string | null; reportChannelId: string | null; managerRoleIds: string[]; googleSheetsServiceAccountEmail: string | null; spreadsheetEnabled: boolean; spreadsheetId: string | null; spreadsheetSheetName: string | null; spreadsheetLastSyncAt: string | null; spreadsheetSyncError: string | null; panelMessageId: string | null; panelTitle: string; panelDescription: string; color: string; imageUrl: string | null; imagePosition: "top" | "center" | "bottom" | "none"; lastPanelRequestedAt: string | null; createdAt: string; updatedAt: string };
