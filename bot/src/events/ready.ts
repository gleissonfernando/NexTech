...
function runtimeModuleTasks(client: Client<true>, context: BotContext): BotBootTask[] {
  ...
  runtimeModuleTask("police-recruitment", "normal", isBotModuleEnabled("police-recruitment") || isBotModuleEnabled("police_reports"), () => startPoliceRecruitmentService(client, context)),
  runtimeModuleTask("police-qru-ranking", "background", isBotModuleEnabled("police-qru"), () => startPoliceQruRankingService(client, context)),
