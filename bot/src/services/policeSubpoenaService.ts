...
function subpoenaTranscriptUrl(transcript: Awaited<ReturnType<BotContext["api"]["createTranscript"]>>) { return transcript.publicUrl || transcript.transcript.publicUrl || `https://nextech.discloud.app/transcripts/${transcript.transcript.id}`; }
