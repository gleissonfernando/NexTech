...
import { ammunitionRouter } from "./ammunition";
import { weaponSalesRouter } from "./weaponSales";
...
import { fivemExpensesRouter } from "./fivemExpenses";
...
import { policeRecruitmentRouter } from "./policeRecruitment";
import { policePromotionsRouter } from "./policePromotions";
import { policeQruRouter } from "./policeQru";
import { policeRankUpRouter } from "./policeRankUp";
...
apiRouter.use("/ammunition", ammunitionRouter);
apiRouter.use("/weapon-sales", weaponSalesRouter);
...
apiRouter.use("/fivem-expenses", fivemExpensesRouter);
...
apiRouter.use("/police-recruitment", policeRecruitmentRouter);
...
apiRouter.use("/police-rank-up", policeRankUpRouter);
