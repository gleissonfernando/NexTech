...
export type GuildSettingsDto = {
  ...
  ticketPanelFooterImage: PanelImageSettingsDto | null;
...
export async function updateGuildSettings(
  ...
  const next = normalizeVerificationRoles({
    ...
    termsPanelTitle: normalizePanelText("termsPanelTitle" in input ? input.termsPanelTitle : current.termsPanelTitle) || "Termos & Serviço",
    termsPanelSubtitle: normalizePanelText("termsPanelSubtitle" in input ? input.termsPanelSubtitle : current.termsPanelSubtitle),
    termsPanelDescription: normalizePanelMessage("termsPanelDescription" in input ? input.termsPanelDescription : current.termsPanelDescription),
    termsPanelColor: normalizeTermsPanelColor("termsPanelColor" in input ? input.termsPanelColor : current.termsPanelColor),
    termsPanelFooterText: normalizePanelText("termsPanelFooterText" in input ? input.termsPanelFooterText : current.termsPanelFooterText),
...
function toDto(settings: MongoGuildSettings): GuildSettingsDto {
  ...
  return normalizeVerificationRoles({
    ...
    termsPanelTitle: normalizePanelText(settings.termsPanelTitle) || "Termos & Serviço",
    termsPanelSubtitle: normalizePanelText(settings.termsPanelSubtitle),
    termsPanelDescription: normalizePanelMessage(settings.termsPanelDescription),
    termsPanelColor: normalizeTermsPanelColor(settings.termsPanelColor),
    termsPanelFooterText: normalizePanelText(settings.termsPanelFooterText),
    ...
    termsPanelImageFormat: normalizeRulesImageFormat(settings.termsPanelImageFormat) === "none" ? "horizontal" : normalizeRulesImageFormat(settings.termsPanelImageFormat),
    termsPanelImageUrl: normalizeOptionalUrl(settings.termsPanelImageUrl) || "/terms-banner.png",
