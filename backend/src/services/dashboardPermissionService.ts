...
const PREMIUM_MODULE_IDS = new Set(["live", "kick-integration", "clips", "kick-clips", "giveaway", "updates", "payment-gateway", "manual-payments", "custom-bot-orders", "network", "x-monitor", "voice-recorder", "emoji-cloner", "server-cloner", "server-generator", "rules", "terms-panel", "account-age-security", "safe-bot", "anti-abuse", "anti-disconnect", "courses", "rh-admin", "fivem", "fivem-factions", "fivem-corporations", "fivem-absences", "fivem-washing", "fivem-drugs", "fivem-finance", "fivem-goals", "fivem-captcha", "fivem-commands", "fivem-hierarchy", "police-absences", "police-actions", "police-iab", "police-hr", "police-daf-roster", "police-courses", "police-patrol-reports", "police-recruitment", "police-qru", "police-promotions", "police-rank-up", "vehicle-abandonment", "police-hidden-channel", "visible-message", "message-control", "police-dm", "police-subpoenas", "police-open-duty", "police-time-clock"]);
