...
export const FIXED_SYSTEM_EMOJI_BY_KEY: Readonly<Record<SystemEmojiKey, FixedSystemEmojiDefinition>> = {
  ...
  prancheta: { name: "prancheta", emojiId: "1525682244893544489", animated: false },
  ...
  prancheta_acertos: { name: "prancheta_acertos", emojiId: "1525682188798922853", animated: false },
  ...
  salvar: { name: "prancheta_acertos", emojiId: "1525682188798922853", animated: false },
